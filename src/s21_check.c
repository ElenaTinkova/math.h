...
START_TEST(test_cos) {
  ...
  ck_assert_ldouble_eq_tol(s21_cos(1.732050808), cos(1.732050808),
                           S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_cos(-0.999999), cos(-0.999999), S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_cos(0.000001), cos(0.000001), S21_MIN_TEST);
}
END_TEST
...
START_TEST(test_exp) {
  ...
  ck_assert_ldouble_eq_tol(s21_exp(1.732050808), exp(1.732050808),
                           S21_MIN_TEST);
  ck_assert_ldouble_infinite(s21_exp(S21_DOUBLE_MAX));
}
END_TEST
...
START_TEST(test_sin) {
  ...
  ck_assert_ldouble_eq_tol(s21_sin(1.732050808), sin(1.732050808),
                           S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_sin(123456789.123456), sin(123456789.123456),
                           S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_sin(-123456789.123456), sin(-123456789.123456),
                           S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_sin(0.999999), sin(0.999999), S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_sin(-0.999999), sin(-0.999999), S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_sin(0.000001), sin(0.000001), S21_MIN_TEST);
}
END_TEST
...
START_TEST(test_tan) {
  ...
  ck_assert_ldouble_eq_tol(s21_tan(-2.5), tan(-2.5), S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_tan(12345645.123456), tan(12345645.123456),
                           S21_MIN_TEST);
  ck_assert_ldouble_eq_tol(s21_tan(-12345645.123456), tan(-12345645.123456),
                           S21_MIN_TEST);
}
